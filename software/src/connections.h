...
void wait_for_new_connections(struct network_struct* network, struct device_table_struct* connected_devices, struct device_table_struct* local_devices); // receives server and network connections
void receive_connections(struct network_struct* network, struct system_config_struct* system_config, struct device_table_struct* connected_devices, struct device_table_struct* local_devices); // receives server and network connections
